              ...
              <div class="tab-content" id="custom-tabs-four-tabContent">
                ...
                <table id="table" class="table table-bordered table-striped">
                  <thead>
                    ...
                    <tbody>
                      @foreach($data_rekening as $val)
                        <tr>
                          <td>{{ $val->nama_bank }}</td>
                          <td>{{ $val->no_rekening }}</td>
                          <td><center>
                            <a href="{{ url('master/rekening/edit/') }}/{{ md5($val->id) }}" class="btn btn-outline-success btn-sm"><i class="fas fa-edit"></i></a>
                ...
                <div class="tab-pane fade" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
                  ...
                  <form action="{{ route('simpan-rekening') }}" method="POST">
                    @csrf
                    <div class="row">
                      <div class="col-lg">
                        <div class="form-group">
                          <label for="nama_bank">Nama Bank</label>
                          <input type="text" class="form-control" id="nama_bank" name="nama_bank" placeholder="Required" required>
                        </div>
                      </div>
                      <div class="col-lg">
                        <div class="form-group">
                          <label for="no_rekening">Nomor Rekening</label>
                          <input type="text" class="form-control" id="no_rekening" name="no_rekening" placeholder="Required" required>
                        </div>
                      </div>
                      <div class="col-lg-3">
                        <label>&nbsp;</label>
    ...
    $('#table').on('click', '.delete', function(){
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          let link = "{{ url('master/rekening/delete') }}/"+id;
