        ...
        <div class="quickview-content">
            ...
            <div class="quantity">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="qty" id="preview_qty" class="input-number"  min="1" max="{{ $produk->stok }}" value="1">
            ...
            <div class="add-to-cart">
                <button type="button" class="btn" id="btn_add_cart" onclick="addCart()">Add to cart</a>
            </div>
