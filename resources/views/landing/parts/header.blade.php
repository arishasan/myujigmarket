                	...
                	<div class="d-flex align-items-center justify-content-center justify-content-md-start">
                        <div class="lng_dropdown mr-2">
                            <!-- <select name="countries" class="custome_select">
                                <option value='en' data-image="{{ asset('new') }}/images/eng.png" data-title="English">English</option>
                                <option value='fn' data-image="{{ asset('new') }}/images/id.png" data-title="Indonesia">Indonesia</option>
                            </select> -->
                        </div>
                        <div class="mr-2">
                        </div>
                ...
                <div class="col-md-6">
                	<div class="text-center text-md-right">
                       	<ul class="header_list">
                            ...
                            <li><a href="{{ route('akunku') }}"><i class="ti-user"></i>{{ Session::get('sess_nama') }}</a></li>
                            <li><a href="{{ route('wishlistku') }}"><i class="ti-heart"></i><span>Wishlist</span></a></li>
                            <li><i class="ti-power-off"></i><a href="{{ route('logout-customer') }}">Logout</a></li>
                            @else
                            <li><a href="{{ url('customer/login') }}">Login</span></a></li>
                            @endif
    	...
    	<div class="container">
            <nav class="navbar navbar-expand-lg"> 
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img class="logo_light" src="{{ asset('new') }}/images/mm.png" alt="logo" />
                    <img class="logo_dark" src="{{ asset('new') }}/images/mm.png" alt="logo" />
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li><a class="nav-link nav_item {{ Request::is('/') ? 'active' : '' }}" href="{{ url('/') }}">Home</a></li> 
                        <!-- <li><a class="nav-link nav_item" href="#">SALE</a></li>  -->
                        <!-- <li class="dropdown">
                        ...
                        <li><a class="nav-link nav_item" href="#">FAQ</a></li>
                    </ul>
                </div>
                <ul class="navbar-nav attr-nav align-items-center">
                    <li><a href="javascript:void(0);" class="nav-link search_trigger"><i class="linearicons-magnifier"></i></a>
                        <div class="search_wrap">
                            ...
                            <form action="{{ url('landing/produk/semua') }}" method="POST">
                                @csrf
                                <input type="text" name="cari" placeholder="Search" class="form-control" id="search_input">
                                <button type="submit" class="search_icon"><i class="ion-ios-search-strong"></i></button>
                            </form>
                        </div><div class="search_overlay"></div>
                    </li>
                    @if(App\Models\HelperModel::getLoginPembeli())
                    <li class="dropdown cart_dropdown"><a class="nav-link " href="{{ route('keranjang-belanja') }}" ><i class="linearicons-cart"></i><span class="cart_count">{{ App\Models\HelperModel::getCount('cart') }}</span></a>
                    <!-- cart_trigger -->
                        ...
                        <!-- <div class="cart_box dropdown-menu dropdown-menu-right">
                            <ul class="cart_list">
                                <li>
                                    ...
                                    <a href="#"><img src="{{ asset('new') }}/images/cart_thamb1.jpg" alt="cart_thumb1">Variable product 001</a>
                    ...
                    <li><a href="{{ route('akunku') }}" class="nav-link"><i class="linearicons-user"></i></a></li>
                    @endif
                </ul>
            </nav>
        </div>
